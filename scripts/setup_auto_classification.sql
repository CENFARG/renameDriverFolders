-- =====================================================
-- SETUP: Clasificacion Automatica de Documentos
-- =====================================================
-- Ejecutar en: https://supabase.com/dashboard/project/uenywfvtuulcjelouork/sql/new
--
-- Este script crea la tabla de algoritmos y popula con
-- 6 algoritmos preconfigurados.
-- NOTA: Nombre de tabla sin acentos para evitar problemas
-- =====================================================

-- Paso 1: Crear tabla de algoritmos (sin acento)
...
-- Crear indices para busqueda eficiente
...
-- =====================================================
-- Paso 2: Insertar algoritmos preconfigurados
-- =====================================================
...
Output JSON:
{
  ...
  "observaciones": string
    ...
    '{"servicio": "string", "tipo_factura": "string", "periodo": "string", "cuit_emisor": "string", "numero_factura": "string", "fecha_emision": "string", "importe": "string", "vencimiento": "string"}'::jsonb,
...
Output JSON:
{
  ...
  "fecha_pago": string (YYYY-MM-DD)
    ...
    '{"tipo_documento": "string", "periodo_pago": "string", "empleado": "string", "cuil": "string", "empleador": "string", "cuit_empleador": "string", "monto_neto": "string", "fecha_pago": "string"}'::jsonb,
...
Output JSON:
{
  ...
  "fecha_corte": string (YYYY-MM-DD)
    ...
    '{"banco": "string", "tipo_documento": "string", "periodo_corte": "string", "tipo_cuenta": "string", "saldo_final": "string", "fecha_corte": "string"}'::jsonb,
...
Output JSON:
{
  ...
  "moneda": string
    ...
    '{"tipo_informe": "string", "empresa": "string", "ejercicio": "string", "fecha_cierre": "string", "resultado": "string"}'::jsonb,
...
Output JSON:
{
  ...
  "empresa": string o null
    ...
    '{"tipo_contrato": "string", "fecha_inicio": "string", "monto": "string", "empresa": "string"}'::jsonb,
...
Output JSON:
{
  ...
  "ext": string (extension del archivo)
    ...
    '{"date": "string", "type": "string", "keywords": ["string", "string", "string"], "entity": "string", "concept": "string", "ext": "string"}'::jsonb,
...
-- Mostrar resumen de algoritmos creados
SELECT
    id,
    name,
    is_active,
...
-- Comentario final
COMMENT ON TABLE document_algorithms IS 'Algoritmos de clasificacion y renombrado automatico de documentos. Cada algoritmo tiene criterios de clasificacion, instrucciones de extraccion y formato de nombre de archivo.';
